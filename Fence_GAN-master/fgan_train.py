...
def train(args, G ,D, GAN, x_train, x_test, y_test, x_val, y_val):
    ...
    dir_result = os.path.join(path_project, 'Fence_GAN-master', 'results_origin/{}/'.format(args.dataset))
    if not os.path.exists(dir_result):
        os.makedirs(dir_result)
    result_path = os.path.join(path_project, 'Fence_GAN-master', 'results_origin/{}/{}'.format(args.dataset,len(os.listdir(dir_result))))
