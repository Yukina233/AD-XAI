...
class AETrainer(BaseTrainer):
    ...
    def train_normal(self, dataset: BaseADDataset, ae_net: BaseNet):
    ...
    def train_anomaly(self, dataset: BaseADDataset, ae_net: BaseNet):
        logger = logging.getLogger()

        # Get train data loader
        train_anomaly_loader = dataset.anomaly_data_loader(batch_size=self.batch_size, num_workers=self.n_jobs_dataloader)
