...
def collect_data_to_groups(base_path):
    ...
    for folder_name in os.listdir(base_path):
        # if "ratioNormal=0" not in folder_name:
        #     continue
...
base_path = '/home/yukina/Missile_Fault_Detection/project/Deep-SAD-OriginalPaper/log/remove/seperate_normal, remove_threshold=0/cifar10/ae_epochs=100/ratio=0.2'  # Replace with the path to your dataset directories
