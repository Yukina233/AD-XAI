...
if __name__ == '__main__':
    ...
    model_path = os.path.join(path_project, f'GHL_dataset/models/{test_set_name}/ensemble/{model_name}/{iteration}')
    ...
    output_path = os.path.join(path_project,
                               f'GHL_dataset/log/{test_set_name}/ensemble/DeepSAD/{model_name}/{iteration}')
