...
model_name = 'K=2,gan_epoch=100,lam=10,tau=1'
path_plot = os.path.join(path_project, 'adversarial_ensemble_AD/log/train_result', model_name, 'generated_data')
os.makedirs(path_plot, exist_ok=True)

path_train_new = os.path.join(path_project, 'data/banwuli_data/yukina_data/train_seperate', 'augment/error3', model_name, '4')
