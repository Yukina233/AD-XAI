...
if __name__=="__main__":
    ...
    input_path = os.path.join(path_project, f"data/{dataset_name}/csv/window=100, step=10")
    ...
    # 保存结果到CSV文件
    results_csv_path = os.path.join(path_project, f'{dataset_name}_dataset/autoencoder/results/{suffix}/results.csv')
