...
class CIFAR10_LeNet_1_Decoder(BaseNet):
...
class CIFAR10_LeNet_1_Autoencoder(BaseNet):

    def __init__(self, rep_dim=128):
        super().__init__()

        self.rep_dim = rep_dim
        self.encoder = CIFAR10_LeNet_1(rep_dim=rep_dim)
        self.decoder = CIFAR10_LeNet_1_Decoder(rep_dim=rep_dim)
