...
train_new_dir = os.path.join(path_project, f'data/{test_set_name}/yukina_data/ensemble_data, window=100', 'augment', model_name)

detector_dir = os.path.join(path_project, f'SMD_dataset/models/{test_set_name}/ensemble', model_name)

test_data_path = os.path.join(path_project, f'data/{test_set_name}/yukina_data/DeepSAD_data, window=100')
