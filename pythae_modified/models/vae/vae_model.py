...
class VAE(BaseAE):
    ...
    def calculate_elementwise_loss(self, inputs: BaseDataset, **kwargs):
        ...
        Returns:
            ModelOutput: An instance of ModelOutput containing all the relevant parameters and elementwise loss
        ...
        loss, recon_loss, kld = self.elementwise_loss_function(recon_x, x, mu, log_var, z)
    ...
    def elementwise_loss_function(self, recon_x, x, mu, log_var, z):
