...
from .vq_vae_utils import Quantizer, QuantizerEMA, Simplified_QuantizerEMA
...
class VQVAE(AE):
    ...
    def calculate_elementwise_loss(self, inputs: BaseDataset, **kwargs):
        """
        The VAE model
        ...
        loss, recon_loss, vq_loss = self.elementwise_loss_function(recon_x, x, quantizer_output)
    ...
    def elementwise_loss_function(self, recon_x, x, quantizer_output):
    ...
    def get_codebook(self):
        return self.quantizer.embeddings

class Simplified_VQVAE(AE):
    r"""
    Vector Quantized-VAE model.
    ...
    def __init__(
        ...
        self.model_name = "Simplified_VQVAE"
    ...
    def _set_quantizer(self, model_config):
        ...
        self.model_config.embedding_dim = z.shape[-1]
        if model_config.use_ema:
            self.quantizer = Simplified_QuantizerEMA(model_config=model_config)
