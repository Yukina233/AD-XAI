...
for iteration in iterations:
    ...
    test_set_name = 'Metro'
    model_name = 'GAN1_continue, window=1, step=1, no_tau2_K=7,deepsad_epoch=1,gan_epoch=1,lam1=1000,lam2=100,lam3=0,latent_dim=5,lr=0.002,seed=0'
    output_dir = os.path.join(path_project, f'{test_set_name}_dataset/log/{test_set_name}/train_result', model_name)

    train_new_dir = os.path.join(path_project, f'data/{test_set_name}/yukina_data/ensemble_data, window=1, step=1', 'augment', model_name)

    detector_dir = os.path.join(path_project, f'{test_set_name}_dataset/models/{test_set_name}/ensemble', model_name)
