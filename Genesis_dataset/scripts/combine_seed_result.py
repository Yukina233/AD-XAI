...
if __name__ == '__main__':
    # 定义根目录
    base_dir = os.path.join(path_project, 'Genesis_dataset/log/Genesis/ensemble/DeepSAD')
    prefix = 'GAN1_continue, window=1, step=1, no_tau2_K=7,deepsad_epoch=1,gan_epoch=1,lam1=100000,lam2=0,lam3=0,latent_dim=18,lr=0.002,seed'
    # 调用函数
