...
input_path = os.path.join(path_project, 'data/Genesis')
output_path = os.path.join(path_project,
                           f'data/Genesis/yukina_data/DeepSAD_data, window={window_size}, step={step_size}')
plot_path = os.path.join(path_project, f'data/Genesis/plot/DeepSAD_data, window={window_size}, step={step_size}')
